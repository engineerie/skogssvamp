<template>
  <div
    class="relative h-fit backdrop-blur-3xl rounded-xl bg-neutral-50 dark:bg-neutral-900 dark:bg-opacity-60 border-[1px] dark:border-neutral-800 border-stone-200"
  >
    <div class="p-6 pb-0">
      <div class="grid grid-cols-4">
        <div class="col-span-3">
          <h1 size="md">Artrikedom</h1>
          <p size="sm" class="mb text-neutral-500">
            Antal mykorrhiza som beräknas finnas i denna miljö.
          </p>
        </div>
        <div class="col-span-1 flex justify-end">
          <Icon
            name="game-icons:mushrooms"
            class="dark:opacity-90 w-8 h-8 mb-4 rounded-lg text-green-500 flex justify-center items-center"
          />
        </div>
      </div>
    </div>
    ...
    <!-- <div class="flex gap-4 -mt-16 justify-center">
      <h1 v-if="dataLoaded" size="3xl" width="medium" color="primary" class="inline-flex justify-center">
        {{ RedlistedSpecies }}
      </h1>
      <p v-else size="md" color="primary">
        Loading...
      </p>
    </div>
    <div class="flex justify-center -mt-16 mb-8">
    <h1 size="lg" weight="medium" color="primary" class="inline-flex justify-center">
      arter
    </h1>
  </div> -->
  </div>
