...
// Reactive state for color based on sampleEnvCount
const color = computed(() => {
  if (!sampleEnvCount.value) return "primary";
  if (sampleEnvCount.value < 10) return "red";
  if (sampleEnvCount.value < 50) return "amber";
  return "primary";
});
...
// Function to get the icon path based on Svamp-grupp-släkte
...
// Define Columns for UTable (Normal View)
const columns = [
  // {
...
const filteredData = computed(() => {
  ...
  // Apply Search Filter (Disabled in Normal View as Search Input is Hidden)
  // If you plan to keep the search functionality, you can enable it here
  /*
