<template>
  ...
  <div
    class="grid grid-cols-2 gap-3 p-5 pb-4 dark:border-neutral-800 border-neutral-00 w-fulloverflow-y-scroll shrink-0"
  >
    <div>
      <!-- Geography Selection -->
      <div>
      ...
      <!-- Forest Type Options -->
      <div>
        <label class="text-neutral-400 text-sm pt-2">Skogstyp</label>
        <div
    ...
    <div>
      ...
      <div>
        <label class="text-neutral-400 text-sm mt-4">Fältskikt</label>
        <div
          class="relative p-6 pb-4 backdrop-blur-3xl rounded-xl bg-neutral-50 bg-opacity-40 dark:bg-neutral-900 dark:bg-opacity-10 border-[1px] dark:border-neutral-700 dark:border-opacity-30 border-stone-200 h-fit"
        >
          <div>
