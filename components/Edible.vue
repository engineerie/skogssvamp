  ...
  >
    <div class="grid grid-cols-4 mb-8">
      <div class="col-span-3">
        <div>
          <h1 size="md">Matsvampar</h1>
          <p size="sm" class="mb text-neutral-500">
            Ätbara arter som kan förekomma i denna miljö.
          </p>
        </div>
      </div>
      <div class="col-span-1 flex justify-end gap-2">
        ...
        <UButton shape="full" @click="$emit('enlarge')" size="sm" class="my-2">
          <Icon name="material-symbols:open-in-full" class="size-4" />
        </UButton>
        <UButton shape="full" size="sm" class="my-2">
    ...
    >
      ...
      <UButton
        to="https://svampguiden.com/art/visa/leccinum_rufum"
        target="_blank"
        shape="full"
        size="sm"
      >
...
const mushrooms = ref([
  ...
  { name: "Blek ostronmussling", edibilityRating: 4 },
  { name: "Blek taggsvamp", edibilityRating: 5 },
  { name: "Blodchampinjon", edibilityRating: 3 },
  { name: "Blomkålssvamp", edibilityRating: 5 },
  { name: "Bllåmusseron", edibilityRating: 3 },
  { name: "Brokkremla", edibilityRating: 3 },
