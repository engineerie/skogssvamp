<template>
  ...
  /> -->
    ...
    <BaseMessage type="info" icon class="mt-2">
      De flesta skogsbrukscenarion saknar bilder. Använd tidslinjen vid skärmens nedre kant för att se avverkning och återväxt över tid. 
    </BaseMessage>
...
{ id: 'hyggesstorlek', title: 'Hyggesstorlek', icon: 'material-symbols:resize', radioOptions: ['1 ha', '5 ha', '20 ha'], description: 'Information om hyggesstorlek ' },
